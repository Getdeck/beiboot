...
@cluster.command("delete", alias=["rm", "remove"], help="Mark a Beiboot cluster for deletion")
@click.argument("name")
@click.pass_context
@standard_error_handler
...
@cluster.command("list", alias=["ls"], help="List all Beiboot cluster (filtered when labels option is used)")
@click.option(
    "--label",
    "-l",
    type=str,
...
@cluster.command("inspect", alias=["get"], help="Display detailed information of one Beiboot")
@click.argument("name")
@click.pass_context
@standard_error_handler
